  ...
  const handleSaveEditDraftSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const updatedFields: Partial<DraftVitrine> = {
        ...
        vitrineEndereco: editEndereco.trim(),
        vitrineLocalizacao: editEndereco.trim(),
        ...
        vitrineHorarioHoje: editingDraft.vitrineHorarioHoje || editingDraft.horarioHoje,
        horarioHoje: editingDraft.horarioHoje || editingDraft.vitrineHorarioHoje,
